...
void SceneW3::Initialize()
{
    ...
    //const auto matCT_GrayRoughMetal = AddMaterial(new dae::Material_SolidColor({ .972f, .960f, .915f }));
    //const auto matCT_GrayMediumMetal = AddMaterial(new dae::Material_SolidColor({ .972f, .960f, .915f }));
    //const auto matCT_GraySmoothMetal = AddMaterial(new dae::Material_SolidColor({ .972f, .960f, .915f }));
    //const auto matCT_GrayRoughPlastic = AddMaterial(new dae::Material_SolidColor({ .75f, .75f, .75f }));
    //const auto matCT_GrayMediumPlastic = AddMaterial(new dae::Material_SolidColor({ .75f, .75f, .75f }));
    //const auto matCT_GraySmoothPlastic = AddMaterial(new dae::Material_SolidColor({ .75f, .75f, .75f }));
    ...
    //const auto matLambert_White = AddMaterial(new dae::Material_SolidColor(dae::colors::White));
    //const auto matLambert_GrayBlue = AddMaterial(new dae::Material_SolidColor({ .49f, 0.57f, 0.57f }));
