...
void SceneW3::Initialize()
{
	...
	const auto matLambertPhong1 = AddMaterial(new dae::Material_LambertPhong(dae::colors::Blue, 0.5f, 0.5f, 3.f));
	const auto matLambertPhong2 = AddMaterial(new dae::Material_LambertPhong(dae::colors::Blue, 0.5f, 0.5f, 15.f));
	const auto matLambertPhong3 = AddMaterial(new dae::Material_LambertPhong(dae::colors::Blue, 0.5f, 0.5f, 50.f));
...
//    const unsigned char matId_LambertPhong_Blue = AddMaterial(new dae::Material_LambertPhong{ dae::colors::Blue, 1.f, 1.f, 10.f });
//
//    //Spheres
